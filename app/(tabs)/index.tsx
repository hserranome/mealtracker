...
import { type Days, caloriesSchedule$, dairy$, defaultMealNames } from "~/data";
...
export default observer(function DairyScreen() {
	...
	const estimatedCalories = caloriesSchedule[dayOfWeek] ?? "N/A";
	const consumedCalories =
		dairy$.getEntry(dateString).nutriments?.energy_kcal ?? "N/A";
